						...
						<?php }?>
						        ...
						        <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
        							...
        							<div class="row row-xs mb-1" style="line-height: 0px;height: 55px;">
        								...
        								<?php if(!empty($edit)){?>
        						        	<div class="row row-xs my-3" style="line-height: 0px;">
        								<div id='t_more' class="col-md-12 mg-t-10 mg-md-t-0">
        								...
        								<div class="col-md-6 mg-t-10 mg-md-t-0">
        								    <a href="#" id="send" class="btn-block add-to-cart btn btn-warning-gradient rounded-10 pd-x-25 box-shadow-danger" type="button">ویرایش</a>
        								</div>
        								<div class="col-md-6 mg-t-10 mg-md-t-0">
        									<a href="<?php echo base_url().'content'.DS.'show_content'.DS.$edit;?>" class="add-to-cart btn btn-block btn-danger-gradient rounded-10 pd-x-25 box-shadow-pink" type="button">انصراف</a>
        								</div>
        								</div>
        								<?php }else{?>
        								...
        								<div class="col-md-6 mg-t-10 mg-md-t-0">
        									<a href="<?php echo base_url().'content';?>" class="add-to-cart btn btn-block btn-danger-gradient rounded-10 pd-x-25 box-shadow-pink" type="button">انصراف</a>
        								</div>
        								</div>
    ...
    $(document).ready(function (){
        ...
        $("#send").click(function(){
            ...
            if(title == '' || content == '' || pi=='0' || pi=='' || des == ''){
                ...
                <?php if(!empty($edit)){?>
                let id="<?php if(is_numeric($edit)){echo $edit;}?>";
                let editor ='<?= (!empty($editor)?$editor:'')?>';
                let rate =$('#rate').val();
                $.ajax({
                    method:'post',
                    url:"<?php echo base_url();?>content/check_edit",
                    data:{pi:pi,title:title,content:content,des:des,style:style,send:send,id:id,editor:editor,rate:rate},
                        ...
                        if(values==0){
                            swal({
                                ...
                                button: "متوجه شدم"
                                     ...
                                     window.location.replace("<?php echo base_url();?>content/edit_content/"+id); 
                            });
                        }
                        if(values==1){
                            swal({
                ...
                $.ajax({
                    ...
                    data:{pi:pi,title:title,content:content,des:des,style:style,send:send,},
                    success:function (values){
                        if(values==0){
                            swal({
                                title: "خطا در اطلاعات",
                                ...
                                button: "متوجه شدم"
                                     ...
                                     window.location.replace("<?php echo base_url();?>content/add_content"); 
                            });
                        }
                        if(values==1){
                            swal({
