        ...
        <div class="col-lg-12 col-md-12 my-5">
			<div class="card">
    			<div class="card-body">
					...
					<a style="float:left;padding: 7px;color:red;" title="انصراف" href="<?php echo base_url()."sidebars";?>"><i class="fa fa-times" aria-hidden="true"></i></a>
					...
					<div class="pd-30 pd-sm-20 bg-gray-200">
						<?php echo form_open();?>
							...
							<div class="row row-xs mt-3" style="line-height: 0px;height: 55px;">	
        						...
        						<div class="col-md-6 mg-t-10 mg-md-t-0">
        							<a href="<?php echo base_url().'sidebars';?>" class="add-to-cart btn btn-block btn-danger-gradient rounded-10 pd-x-25 box-shadow-pink" type="button">انصراف</a>
        						</div>
							</div>
					    <?php echo form_close();?>
					</div>
    ...
    $(document).ready(function (){
        $("#send").click(function(){
            ...
            if(title==''){
                ...
                $.ajax({
                        method:'post',
                        url:"<?php echo base_url();?>sidebars/edit_side_check",
                        data:{sideBtn:sideBtn,map:map, title : title , place : place , customHtml : customHtml , endCustomHtml : endCustomHtml , send : send ,css:css, id : id},
                        success:function (values){
                            if(values==0){
                                swal({
                                    ...
                                    button: "متوجه شدم"
                                         ...
                                         window.location.replace("<?php base_url();?>sidebars/edit_side/"+id); 
                                });
                            }
                            if(values==1){
                                swal({
                                    ...
                                    window.location.replace("<?php echo base_url();?>sidebars"); 
                                });
                            }
                        ...
                        if(values==0){
                            swal({
                                ...
                                button: "متوجه شدم"
                                     ...
                                     window.location.replace("<?php echo base_url();?>sidebars/add_side"); 
                            });
                        }else{
                            $.ajax({
                                method:'post',
