...
<div class='my-5 container fluid' style="min-height:480px;">   
    <div class='row row-sm'>
			 <div class="col-xl-12 my-5">
        					<div class="card">
        						     <a href="<?= base_url()?>slider" style='float:left;padding:7px;color:red;' title="انصراف"><i class='fa fa-times' aria-hidden='true'></i></a>
        						<div class="card-body h-100">
        							<div class="row row-sm ">
        								<div class=" col-xl-5 col-lg-12 col-md-12">
        								    <h6 style="margin-bottom:0px;">افزودن عکس به اسلایدر</h6>
							        ...
							        <ul class="preview-thumbnail nav nav-tabs" id="pic_select">
							            ...
							            foreach($pics as $pic_info){$sho=$pic_info['id'].':'.rand(0,99); $picssss.=$sho.','; ?>
							            <li>
						        ...
						        <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
        							...
        							<div class="row row-xs mb-1" style="line-height: 0px;height: 55px;">
        								...
        								<div class="col-md-6 mg-t-10 mg-md-t-0 d-none">
        								...
        								<div class="col-md-6 mg-t-10 mg-md-t-0">
        									<a href="<?php echo base_url().'slider';?>" class="add-to-cart btn btn-block btn-danger-gradient rounded-10 pd-x-25 box-shadow-pink" type="button">انصراف</a>
        								</div>
        								</div>
        						    <?= form_close()?>
    ...
    $(document).ready(function (){
        ...
        $("#send").click(function(){
            ...
            if(title == '' || pi=='0' || pi==''){
                ...
                $.ajax({
                    method:'post',
                    url:"<?php echo base_url();?>slider/check_edit",
                    data:{pi:pi,title:title,style:style,s_h:s_h,e_h:e_h,type:type,send:send,id:id},
                        ...
                        if(values==0){
                            swal({
                                ...
                                button: "متوجه شدم"
                                     ...
                                     window.location.replace("<?php echo base_url();?>slider/edit/"+id); 
                            });
                        }
                        if(values==1){
                            swal({
                ...
                $.ajax({
                    method:'post',
                    url:"<?php echo base_url();?>slider/check_add",
                    data:{pi:pi,title:title,style:style,s_h:s_h,e_h:e_h,type:type,send:send,},
                    success:function (values){
                        if(values==0){
                            swal({
                                title: "خطا در اطلاعات",
