        					...
        					<div class="card">
						        ...
						        <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
        							...
        							<div class="row row-xs mb-1" style="line-height: 0px;height: 55px;">
        								...
        								<div class="row row-xs mb-1" style="line-height: 0px;height: 55px;">
        								<div class="col-md-6 mg-t-10 mg-md-t-0">
        								    <a href="#" id="send_slider" class="btn-block add-to-cart btn btn-warning-gradient rounded-10 pd-x-25 box-shadow-danger" type="button">افزودن</a>
        								</div>
        								<div class="col-md-6 mg-t-10 mg-md-t-0">
                ...
                $.ajax({
                    ...
                    success:function (values){
                        ...
                        if(values==1){
                            ...
                            $.ajax({
                                method:'post',
                                url:"<?php echo base_url();?>page/slider_new",
