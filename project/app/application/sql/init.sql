...
--
CREATE TABLE IF NOT EXISTS `company_category_product_position` (
  `id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `company_meet` (
  `id` int NOT NULL,
  `title` varchar(255) NOT NULL,
  `description` text NOT NULL,
  `result` text,
...
--
CREATE TABLE IF NOT EXISTS `company_meet_user` (
  `id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `company_role_request` (
  `id` int NOT NULL,
  `company_id` int NOT NULL,
  `role_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `company_task_user` (
  `id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `package_company_order` (
  `id` int NOT NULL,
  `company_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `position_chat` (
  `id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `position_form` (
  `id` int NOT NULL,
  `position_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `position_form_question` (
  `id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `position_form_question_answer` (
  `id` int NOT NULL,
  `position_form_question_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `position_product_order` (
  `id` int NOT NULL,
  `position_user_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `position_tel` (
  `id` int NOT NULL,
  `position_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `position_video` (
  `id` int NOT NULL,
  `address` varchar(255) NOT NULL,
  `position_id` int NOT NULL,
  `status` int NOT NULL DEFAULT '1'
...
--
CREATE TABLE IF NOT EXISTS `product_change_value` (
  `id` int NOT NULL,
  `product_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `product_price_relations` (
  `id` int NOT NULL,
  `description` text,
  `product_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `product_tel` (
  `id` int NOT NULL,
  `product_id` int NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `user_resume_company_role_request` (
  `id` int NOT NULL,
